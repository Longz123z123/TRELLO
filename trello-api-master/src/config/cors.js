// CORS (Cross-Origin Resource Sharing) là cơ chế bảo mật của trình duyệt chặn các request từ một origin khác với origin của server
//  — trừ khi server cho phép qua header Access-Control-Allow-Origin.
