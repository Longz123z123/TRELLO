...
const markdownValueExample = `
  ...
  **Hello world | zetDev - Một Lập Trình Viên | Trello MERN Stack Advanced**
  \`\`\`javascript
 ...
 */
function CardDescriptionMdEditor({ cardDescriptionProps, handleUpdateCardDes }) {
  ...
  const updateCardDescription = () => {
    ...
    handleUpdateCardDes(cardDescription)
  }
    ...
    <Box sx={{ mt: -4 }}>
      {markdownEditMode ? (
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          <Button sx={{ alignSelf: 'flex-end' }} onClick={() => setMarkdownEditMode(true)} type="button" variant="contained" color="info" size="small" startIcon={<EditNoteIcon />}>
            Edit
          </Button>
          <Box data-color-mode={mode}>
            <MDEditor.Markdown
