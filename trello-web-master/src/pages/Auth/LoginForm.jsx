...
import { EMAIL_RULE, PASSWORD_RULE, FIELD_REQUIRED_MESSAGE, EMAIL_RULE_MESSAGE, PASSWORD_RULE_MESSAGE } from '~/utils/validators'
...
function LoginForm() {
  ...
  const submitLogIn = (data) => {
    ...
    toast
      ...
      .then((res) => {
        // Kiem tra neu k co loi thi dieu huong ve trang home
