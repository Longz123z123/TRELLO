...
function AccountTab() {
  ...
  const submitChangeGeneralInformation = (data) => {
    ...
    toast
      ...
      .then((res) => {
        // Kiem tra neu k co loi ,update thanh cong thuc hien cac hd can thiet
        if (!res.error) {
  ...
  const uploadAvatar = (e) => {
    ...
    toast
      ...
      .then((res) => {
        ...
        // Luu y du api co loi hay khong thi cung phai clear gia tri input, neu khong thi se khong chon cung 1 file lien tiep duoc
        e.target.value = ''
      })
  }
