...
export const activeCardSlice = createSlice({
  ...
  reducers: {
    // Lưu ý luôn là ở đây cần cặp ngoặc nhọn cho function trong redux
    // 1 dòng, đây là rule của Redux
    ...
    updateCurrentActiveCard: (state, action) => {
      const fullCard = action.payload // action.payload là chuẩn đặt tên, dùng để gán nó ra một biến có nghĩa hơn
...
// Ở đây trên thì không thấy properties actions đâu cả, bởi vì những cái actions này đơn giản là được thằng redux tạo tự động theo tên của reducer nhé.
